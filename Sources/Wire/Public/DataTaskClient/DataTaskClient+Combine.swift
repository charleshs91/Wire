...
extension DataTaskClient {
    public func objectPublisher<T, U>(with builder: T, responseConverter: U) -> AnyPublisher<U.Output, BaseError>
    ...
    public func dataPublisher<T>(with builder: T) -> AnyPublisher<Data, BaseError>
